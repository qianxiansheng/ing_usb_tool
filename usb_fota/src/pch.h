...
#define BIN_COLOR_MAX_CONFIG_NUM 6
...
#define IAP_SWITCH_DELAY_MIN 0
#define IAP_SWITCH_DELAY_MAX 1000
#define IAP_REBOOT_DELAY_MIN 0
#define IAP_REBOOT_DELAY_MAX 1000
